...
# MD5 of original .bashrc
original_md5 = '97c448f9292700ae81f301b12457ee66'
...
def compareHashes():
    ...
    if original_md5 == calculated_md5:
        ...
        with open(".bashrc_original", "w") as g:
            g.write(original_bashrc)

        file1 = open(".bashrc", "rb").readlines()
        file2 = open(".bashrc_original", "rb").readlines()
        ...
        os.rename(".bashrc_original", ".bashrc")
        ...
        sendEmail("email.conf", differences)
